% Function to filter float data for A_make_global_gridded_data
%
...
% Small value for float is < 0.014 which is Seabird's listed
% sensitivity for it's mid observation range (0 - 30 ug/L)
% file:///Users/jlong/Desktop/ECOPuckRevC=en.pdf
%
% Save the ratio of fluor2chl as the float chla_npq and MODIS 8 day 4km 
% satellite data
